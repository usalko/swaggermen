...
npx json -I -f package.json -e "this.resolutions[\"@swaggermen/swaggermen-dev-portal\"]=\"file:../../packages/swaggermen-dev-portal/dist\""
...
npx json -I -f package.json -e "this.dependencies[\"@swaggermen/swaggermen-dev-portal\"]=\"file:../../packages/swaggermen-dev-portal/dist\""
