...
describe('createResolvedObject', () => {
  ...
  it('removes object if contains an error for oneOf', () => {
    const originalObject = {
      oneOf: [
        { $ref: '#/__bundled__/0mui9s02880hl', 'x-swaggermen': { id: '19c178fc05d4a' } },
        {
          'x-sl-error-message': 'You do not have permission to view this reference',
          'x-swaggermen': { 'error-message': 'You do not have permission to view this reference', id: 'nezai0hyj4yak' },
        },
        { $ref: '#/__bundled__/iq2mwk8jvthd2', 'x-swaggermen': { id: 'ovj32wmpxpg7p' } },
      ],
      'x-swaggermen': { id: 'b73ff5df9864f' },
    };
