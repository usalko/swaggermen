...
import { SwaggermenProject } from './SwaggermenProject';

describe('Swaggermen Project', () => {
  beforeEach(() => {
  ...
  it('loads correctly using memory router', async () => {
    render(<SwaggermenProject router="memory" projectId="cHJqOjYwNjYx" platformUrl="https://swaggermen.io" />);
