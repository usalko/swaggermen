...
export interface SwaggermenProjectProps extends RoutingProps {
  /**
   * The ID of the Swaggermen Project.
   * @example "d2s6NDE1NTU"
   */
  projectId: string;
  /**
   * If your company runs an on-premise deployment of Swaggermen,
   * set this prop to point the SwaggermenProject component at the URL of that instance.
   */
  platformUrl?: string;
...
const SwaggermenProjectImpl: React.FC<SwaggermenProjectProps> = ({ projectId, collapseTableOfContents = false }) => {
...
const ProjectNode: React.FC<SwaggermenProjectProps> = ({
  hideTryIt,
  hideSecurityInfo,
  hideServerInfo,
  hideMocking,
...
/**
 * The SwaggermenProject component displays a traditional documentation UI for an existing Swaggermen Project.
 */
export const SwaggermenProject = withStyles(SwaggermenProjectRouter);
