...
import { CustomComponentMapping } from '@swaggermen/markdown-viewer';
import { dirname, resolve } from '@swaggermen/path';
...
// Props shared with swaggermen-core Docs component
    ...
    <NodeLinkContext.Provider value={[node, Link]}>
      <MarkdownComponentsProvider
        value={{
          ...
          // rendering of hash routing hrefs for headings in swaggermen-core for the BaseArticleComponent
