    ...
    'x-codeSamples': [
      {
        ...
        label: 'wGet',
        source:
          'wget \'https://api.swaggermen.io/todos/1\' --header=\'Content-Type: application/json\' --header=\'X-Swaggermen-Resolver: true\' --header=\'b-account-id: account-id-default\' --header=\'account-id: account-id-default\' --header=\'message-id: example value\' --header=\'message-id: another example\' --header=\'message-id: something else\' --data-raw \'{"name":"string","completed":true,"id":0,"completed_at":"2021-06-30T14:59:00Z","created_at":"2021-06-30T14:59:00Z","updated_at":"2021-06-30T14:59:00Z","user":{"name":"string","age":0,"type":"STANDARD"}}\'',
      },
      {
        lang: 'shell',
        lib: 'curl',
        source:
          'curl \'https://api.swaggermen.io/todos/1\' --header=\'Content-Type: application/json\' --header=\'X-Swaggermen-Resolver: true\' --header=\'b-account-id: account-id-default\' --header=\'account-id: account-id-default\' --header=\'message-id: example value\' --header=\'message-id: another example\' --header=\'message-id: something else\' --data-raw \'{"name":"string","completed":true,"id":0,"completed_at":"2021-06-30T14:59:00Z","created_at":"2021-06-30T14:59:00Z","updated_at":"2021-06-30T14:59:00Z","user":{"name":"string","age":0,"type":"STANDARD"}}\'',
      },
    ],
  },
  responses: [
