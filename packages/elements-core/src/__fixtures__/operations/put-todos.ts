import { HttpOperationSecurityDeclarationTypes, HttpParamStyles, IHttpOperation } from '@swaggermen/types';
...
export const httpOperation: IHttpOperation = {
  ...
  responses: [
    {
      ...
      headers: [
        {
          id: '?http-header-X-Swaggermen-Resolver?',
          schema: {
            type: 'string',
  ...
  servers: [
    ...
    {
      id: '?http-server-todos-dev.swaggermen.io?',
      description: 'Development',
      url: 'https://todos-dev.swaggermen.io',
    },
    {
      id: '?http-server-todos-pr.swaggermen.io?',
      description: 'PR',
      url: '{proto}://x-{pr}.todos-pr.swaggermen.io:{port}',
      variables: {
        proto: {
          default: 'http',
          enum: ['http', 'https'],
