...
import { IntentVals } from '@swaggermen/mosaic';
import { Dictionary, HttpMethod, HttpSecurityScheme, NodeType } from '@swaggermen/types';
...
export const NodeTypeIconDefs: Readonly<Dictionary<IconDefinition, NodeType>> = {
  ...
  swaggermen_override: faQuestionCircle,
  swaggermen_resolutions: faQuestionCircle,
};
