import { Box, Flex, Heading, NodeAnnotation, VStack } from '@swaggermen/mosaic';
import { withErrorBoundary } from '@swaggermen/react-error-boundary';
import { IHttpService } from '@swaggermen/types';
    ...
    return (
      <Box ref={layoutRef} mb={10} className="HttpService">
        ...
        {pathname && layoutOptions?.showPoweredByLink && (
          <PoweredByLink source={data.name ?? 'no-title'} pathname={pathname} packageType="swaggermen" layout="stacked" />
        )}
