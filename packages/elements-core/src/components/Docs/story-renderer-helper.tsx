...
import { isRegularNode } from '@swaggermen/json-schema-tree';
import { MarkdownViewer } from '@swaggermen/markdown-viewer';
...
export const wrapOptionsContext = (story: any) => {
  return <SwaggermenOptionsProvider renderExtensionAddon={renderExtensionRenderer}>{story}</SwaggermenOptionsProvider>;
};
