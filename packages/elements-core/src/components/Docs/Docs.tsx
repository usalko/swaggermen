import { SchemaNode } from '@swaggermen/json-schema-tree';
import type { NodeHasChangedFn, NodeType } from '@swaggermen/types';
...
interface BaseDocsProps {
  ...
  layoutOptions?: {
    ...
    noHeading?: boolean;
    /**
     * If true, the component will hide the Powered by Swaggermen banner in Docs
     * @default false
     */
...
export const Docs = React.memo<DocsProps>(
  ({
    ...
    return (
      <SwaggermenOptionsProvider nodeHasChanged={nodeHasChanged} renderExtensionAddon={renderExtensionAddon}>
        {elem}
