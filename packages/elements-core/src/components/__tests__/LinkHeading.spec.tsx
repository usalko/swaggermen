...
describe('LinkHeading', () => {
  ...
  describe('given browser router', () => {
    beforeEach(() => {
      jsdom.reconfigure({ url: 'https://swaggermen-demo.swaggermen.io/route' });
    });
    ...
    it('should not append id to the route', () => {
      ...
      expect(baseElement.querySelector('a')).toHaveProperty('href', 'https://swaggermen-demo.swaggermen.io/route#heading');
    });
  ...
  describe('given hash router', () => {
    beforeEach(() => {
      jsdom.reconfigure({ url: 'https://swaggermen-demo.swaggermen.io' });
    });
    ...
    it('should append id to the route', () => {
      ...
      expect(baseElement.querySelector('a')).toHaveProperty(
        'href',
        'https://swaggermen-demo.swaggermen.io/#/route#heading',
      );
    });
