...
export const PoweredByLink: React.FC<{
  source: string;
  pathname: string;
  packageType: 'swaggermen' | 'swaggermen-dev-portal';
  ...
  return (
    <Flex
      ...
      href={`https://swaggermen.io/?utm_source=${packageType}&utm_medium=${source}&utm_campaign=powered_by&utm_content=${pathname}`}
      target="_blank"
    ...
    >
      ...
      <Box>
        powered by&nbsp;<strong>Swaggermen</strong>
      </Box>
    </Flex>
  );
};
