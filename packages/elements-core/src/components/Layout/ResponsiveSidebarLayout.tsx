import { Box, Flex, Heading } from '@swaggermen/mosaic';
...
export const ResponsiveSidebarLayout = React.forwardRef<HTMLDivElement, ResponsiveSidebarLayoutProps>(
  (
    ...
    return (
      <Flex ref={ref} className="sl-swaggermen-api" pin h="full">
...
export const Sidebar = ({
  ...
  return (
    <>
      ...
      <PoweredByLink source={name} pathname={pathname} packageType="swaggermen" />
    </>
  );
};
