import { safeStringify } from '@swaggermen/json';
import { isRegularNode, RegularNode, SchemaNode } from '@swaggermen/json-schema-tree';
import type { IHttpParam, INodeExample, INodeExternalExample } from '@swaggermen/types';
