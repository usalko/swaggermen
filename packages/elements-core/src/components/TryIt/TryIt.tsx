import { Box, Button, HStack, Icon, ITextColorProps, Panel, useThemeIsDark } from '@swaggermen/mosaic';
import type { HttpMethod, IHttpEndpointOperation, IServer } from '@swaggermen/types';
