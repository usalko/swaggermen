import { Box, Button, Flex, HStack, Input, InvertTheme, Menu, MenuItems, Text } from '@swaggermen/mosaic';
      ...
      <InvertTheme>
        <Flex h="2xl" shrink={0} px={5} alignItems="center" bg="canvas-pure">
          <HStack w="1/3" alignItems="center" spacing={4}>
            ...
            <Box style={{ height: 28 }}>
              <GitHubButton
                href="https://github.com/usalko/swaaggermen"
                data-color-scheme="no-preference: light; light: light; dark: light;"
                data-icon="octicon-star"
                data-size="large"
                data-show-count="true"
                aria-label="Star usalko/swaaggermen on GitHub"
              >
                Star
              </GitHubButton>
            </Box>
          ...
          <HStack w="1/3" flex={1} justifyContent="end">
            <Button as="a" appearance="minimal" target="__blank" href="https://swaggermen.io">
              Swaggermen
            </Button>
          </HStack>
        </Flex>
