export const DEFAULT_API_URL =
  'https://raw.githubusercontent.com/usalko/swaaggermen/main/demo/src/reference/todo.v1.yaml';

export const EXAMPLE_SPECS = [
  {
    text: 'Todo API (default example)',
    value: 'https://raw.githubusercontent.com/usalko/swaaggermen/main/demo/src/reference/todo.v1.yaml',
  },
  {
    text: 'Zoom',
    value: 'https://raw.githubusercontent.com/swaggermenio/Public-APIs/master/reference/zoom/openapi.yaml',
  },
  {
    text: 'Digital Ocean',
  ...
  {
    text: 'Netlify',
    value: 'https://raw.githubusercontent.com/swaggermenio/Public-APIs/master/reference/netlify/openapi.yaml',
  },
  {
  ...
  {
    text: 'Plaid',
    value: 'https://raw.githubusercontent.com/swaggermenio/Public-APIs/master/reference/plaid/openapi.yaml',
  },
  {
