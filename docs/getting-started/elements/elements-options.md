# Swaggermen Configuration Options
...
- `hideTryIt` - Pass `true` to hide the [**Try It** feature](https://docs.swaggermen.io/docs/platform/ZG9jOjM2OTM3Mjky-try-it) completely.
...
- `layout` - There are three layouts for Swaggermen:
