...
- `projectId` - Find the Project ID in the Project Settings screen on Swaggermen.
- `platformUrl` - By default, the URL is `https://swaggermen.io/', but you can change it.
...
- `hideTryIt` - Pass `true` to hide the [**Try It** feature](https://docs.swaggermen.io/docs/platform/ZG9jOjM2OTM3Mjky-try-it).
